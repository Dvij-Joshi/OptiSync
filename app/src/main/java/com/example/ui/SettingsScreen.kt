        ...
        Card(
            ...
            Column(modifier = Modifier.padding(16.dp), verticalArrangement = Arrangement.spacedBy(12.dp)) {
                Row(verticalAlignment = Alignment.CenterVertically, horizontalArrangement = Arrangement.spacedBy(8.dp)) {
                    Icon(Icons.Default.Face, "Calibration", tint = MaterialTheme.colorScheme.primary, modifier = Modifier.size(24.dp))
                    Text("Face Calibration", style = MaterialTheme.typography.titleMedium.copy(fontWeight = FontWeight.Bold))
                }
                Text(
                    "Re-run the setup wizard to perfectly align facial thresholds to your current lighting and position.",
                ...
                Button(
                    ...
                    Text("Start Calibration Wizard", fontWeight = FontWeight.Bold)
                }
            }
        }
